(() => {
  ...
  // extensions/example-checkout-address-autocomplete-js/src/suggest.js
  var suggest_default = extension(
    ...
    (_0) => __async(void 0, [_0], function* ({
      ...
      const response = yield fetchSuggestions(signal);
      const suggestions = yield buildSuggestions(response);
      return { suggestions };
    })
  );
  function fetchSuggestions(signal) {
    return __async(this, null, function* () {
      return fetch(
  ...
  function buildSuggestions(response) {
    return __async(this, null, function* () {
      const { result: { suggestions } } = yield response.json();
      if (suggestions) {
...
//# sourceMappingURL=example-checkout-address--js.js.map
